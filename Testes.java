...
class Ex_30 {
  public static void main(String[] args) {
    ...
    System.out.println("O primeiro CILINDRO tem VOLUME " + formatar.format(firCylinder) + "cm³");
    System.out.println("O segundo CILINDRO tem VOLUME " + formatar.format(secCylinder) + "cm³");
